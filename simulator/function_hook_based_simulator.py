...
if __name__ == '__main__':
    ...
    # Start simulation
    target = get_label_address(elf_file, "crypto_kem_dec")-1
    ...
    targets = [
        {"label":"crypto_kem_keypair", "trace":False, "end":False, "arg":[{"label":"pk", "pointer":True, "size":8, "len":9616},
                                                                                {"label":"sk", "pointer":True, "size":8, "len":19888}]},

               {"label":"crypto_kem_enc", "trace":False, "end":False, "arg":[{"label":"ct", "pointer":True, "size":8, "len":9720},
    ...
    for target in targets:
        target["address"] = get_label_address(elf_file, target["label"])-1
